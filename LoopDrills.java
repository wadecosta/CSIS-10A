...
public class LoopDrills
{
   ...
   {  
    ...
    public static void miles2kmTable (int startMi, int stopMi, double stepMi)
    {
        double tempMi = startMi, km;
        while (tempMi <= stopMi)
        {
            km = 1.609344 * tempMi;
            System.out.println(tempMi + "mi = " + km + "km");
            tempMi = tempMi + stepMi;
        }
    }
